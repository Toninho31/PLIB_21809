...
#define WS2812B_DEF(_name, _spi_module, _chip_select, _number_of_leds, ...)                         \
static uint16_t _name ## _segment_ram_allocation[] = {0, __VA_ARGS__ };                             \
static uint8_t _name ## _buffer_ram_allocation[_number_of_leds*9] = {0};                            \
static WS2812B_LED _name ## _led_ram_allocation[_number_of_leds] = {0};                             \
static WS2812B_PARAMS _name = WS2812B_INSTANCE(_spi_module, _chip_select, _name ## _segment_ram_allocation, _name ## _led_ram_allocation, _name ## _buffer_ram_allocation, _number_of_leds)	
